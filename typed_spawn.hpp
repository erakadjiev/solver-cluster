...
struct fiber_creator{

	template<typename Function>
	boost::fibers::fiber operator()(Function&& func){
		return boost::fibers::fiber(std::forward<Function>(func));
	}
...
void spawn( boost::asio::io_service & io_service,
		...
		BOOST_ASIO_MOVE_ARG( Creator) fiber_creator = fiber_creator());
...
#include "typed_spawn_detail.hpp"
